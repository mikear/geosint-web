...
import { Language, getBrowserLanguage, getTranslator } from './i18n';
...
const App: React.FC = () => {
    ...
    const [analysisPhase, setAnalysisPhase] = useState<AnalysisPhase>('queries');
    ...
    const processFile = async (file: File) => {
        ...
        try {
            ...
            console.warn("No se pudieron leer los datos EXIF:", exifError);
            setExifData(null);
            setGeocodedLocation(null);
        }
    };
    ...
    const handleAnalysisClick = useCallback(async () => {
        ...
        try {
            ...
            let coords = null;
            if (finalReport && finalReport.locationName && finalReport.locationName !== 'Ubicación Desconocida') {
    ...
    }, [imageFile, imageUrl, language, geocodedLocation, exifData]);
        ...
        <div className="min-h-screen bg-slate-950 text-white flex flex-col items-center p-4 sm:p-6 lg:p-8 font-sans">
            ...
            <header className="w-full max-w-4xl mb-8 flex justify-between items-center">
                ...
                <div className="flex items-center space-x-2">
                    <button onClick={() => setShowInfoModal(true)} className="p-2 bg-slate-800/50 border border-slate-700 rounded-md hover:bg-slate-700 transition-colors" aria-label="Mostrar información">
