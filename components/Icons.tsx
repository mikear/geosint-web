...
export const LinkedInIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M20.5 2h-17A1.5 1.5 0 0 0 2 3.5v17A1.5 1.5 0 0 0 3.5 22h17a1.5 1.5 0 0 0 1.5-1.5v-17A1.5 1.5 0 0 0 20.5 2ZM8 19H5V8h3v11ZM6.5 6.73c-.97 0-1.75-.78-1.75-1.75S5.53 3.23 6.5 3.23c.97 0 1.75.78 1.75 1.75S7.47 6.73 6.5 6.73ZM20 19h-3v-5.6c0-1.33-.03-3.04-1.85-3.04-1.85 0-2.13 1.45-2.13 2.94V19h-3V8h2.88v1.32h.04c.4-.76 1.37-1.55 2.84-1.55 3.04 0 3.6 2 3.6 4.6V19Z"></path>
    </svg>
);

export const GlobeIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 21a8.956 8.956 0 0 0 3-17.915m-3 17.915a8.956 8.956 0 0 1-3-17.915m3 17.915v-17.915m0 0a8.966 8.966 0 0 0-5.429 2.135M12 3.085a8.966 8.966 0 0 1 5.429 2.135m-10.858 0a8.967 8.967 0 0 1 10.858 0m-10.858 0L3.085 12m17.83 0L20.915 5.22M3.085 12a8.967 8.967 0 0 1 2.135-5.429m12.63 0A8.967 8.967 0 0 1 20.915 12" />
    </svg>
);
