...
import { DocumentTextIcon, ArrowTopRightOnSquareIcon, ShieldCheckIcon, SunIcon, BuildingOfficeIcon, QuestionMarkCircleIcon, ExclamationTriangleIcon, InformationCircleIcon } from './Icons';
...
const DossierDisplay: React.FC<DossierDisplayProps> = ({ analysisData, exifData, geocodedLocation, aiGeocodedCoords, locationDiscrepancy, t }) => {
    const { locationName, description, confidenceScore, forensicAnalysis, environmentAnalysis } = analysisData;
