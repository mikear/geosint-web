...
const ImagePreview: React.FC<ImagePreviewProps> = ({ imageUrl, onClear, t }) => {
    return (
        <div className="mt-4 relative w-full max-w-lg mx-auto group">
            {/* FIX: Use translation key for alt text */}
            <img src={imageUrl} alt={t('imagePreviewAlt')} className="rounded-lg shadow-lg w-full h-auto object-contain max-h-[50vh]" />
            ...
            <button
                ...
                // FIX: Use translation key instead of hardcoded string to avoid type errors
